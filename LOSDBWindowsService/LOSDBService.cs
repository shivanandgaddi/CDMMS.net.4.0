...
using CenturyLink.Network.Engineering.LOSDB.Service.Business;

namespace CenturyLink.Network.Engineering.LOSDB.Service
{
    public class LOSDBService : ServiceBase
    {
        ...
        static void Main()
        {
            ...
            {
                LOSDBService service = new LOSDBService();
        ...
        protected void StartPolling()
        {
            try
            {
                poller = new LOSDBManager();

                poller.Start();
            }
            catch (Exception ex)
            {
                logger.Warn(ex, "LOSDBService.StartPolling() - Initiating service Stop()...");
                EventLogger.LogAlarm(ex, "LOSDBService.StartPolling() - Initiating service Stop()...", SentryIdentifier.EmailDev, SentrySeverity.Major);
        ...
        private void InitializeComponent()
        {
            ...
            this.ServiceName = "LOSDBWindowsService";
        }
