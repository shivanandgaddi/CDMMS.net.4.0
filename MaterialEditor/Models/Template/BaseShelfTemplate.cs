...
{
    public class BaseShelfTemplate : BaseTemplate
    {
        ...
        public BaseShelfTemplate() : base()
        {
            InitializeAttributes();
        }

        public BaseShelfTemplate(long templateId) : base(templateId)
        {
            InitializeAttributes();
        }
        ...
        public override long PersistTemplate(Hashtable tmpltValues)
        {
            ...
            tmpltId = ((ShelfTemplateDbInterface)shelfTemplateDbInterface).CreateBaseTemplate(specRvnsId, (string)tmpltValues["pTmpName"], (string)tmpltValues["pTmpDesc"]);
        ...
        public override void PersistUpdates(JObject updatedTmplt)
        {
            ...
            try
            {
                    ...
                    !UpdateInProgress.Equals(updatedInProgress))
                {
                    ...
                    ((TemplateDbInterfaceImpl)shelfTemplateDbInterface).UpdateTemplate(updatedName, updatedDescription, true, IsHighLevelPartTemplate,
        ...
        {
            List<Slot> slots = ((ShelfTemplateDbInterface)DbInterface).GetSlots(SpecificationId);
